...
st.set_page_config(page_title= "Youtube Data Harvesting and Warehousing | By Jose",
                   page_icon= icon,
                   layout= "wide",
                   initial_sidebar_state= "expanded",
                   menu_items={'About': """# This app is created by *Jose!*"""})
...
api_key = "AIzaSyDl5a3E4ztFOxszaaCU-MqvAAt1RI0DuDc"
channel_ids = ['UCF-DSCW_s3SUafgpt7-QtzA',      #surendar manoj
               'UCY6KjrDBN_tIRFT_QNqQbRQ',      #madan gowri
               'UCnjU1FHmao9YNfPzE039YTw'       #irfans view
              ]
